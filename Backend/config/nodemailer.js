...
export const sendProductDeleteMail = async (email,productid,productname,name) => {
    try {
        // Read HTML template file
        const htmlTemplate = await fs.promises.readFile(path.join(__dirname, '../helper', 'deletedProducts.html'), 'utf-8');
