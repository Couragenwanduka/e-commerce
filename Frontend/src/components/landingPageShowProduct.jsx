...
const SHOWALLPRODUCTSExtra = ({ products: initialProducts }) => {
    ...
    const openModal = (product) => {
        ...
        if (!cookies.token) {
            setErrorMessage('Please sign up or log in to view product details.');
            setIsOpen(true); // Open error modal
            return; // Stop further execution
        }

        // If user is logged in, set the modal product and open the modal
        ...
        <>
            ...
            >
                <div>
                    ...
                    <div className="text-black text-5xl font-sans font-medium">{errorMessage}</div>
                </div>
            </Modal>
        </>
    );
...
export default SHOWALLPRODUCTSExtra ;
